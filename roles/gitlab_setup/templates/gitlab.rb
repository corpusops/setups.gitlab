...
### Email Settings
gitlab_rails['gitlab_email_enabled'] = JSON.load('{{ gitlab_email_enabled | to_json}}')
gitlab_rails['gitlab_email_from'] = JSON.load('{{ gitlab_email_from | to_json}}')
gitlab_rails['gitlab_email_display_name'] = JSON.load('{{ gitlab_email_display_name | to_json}}')
gitlab_rails['gitlab_email_reply_to'] =  JSON.load('{{ gitlab_email_reply_to | to_json}}')
gitlab_rails['gitlab_email_subject_suffix'] = JSON.load('{{ gitlab_email_subject_suffix | to_json}}')

### GitLab user privileges
gitlab_rails['gitlab_default_can_create_group'] = JSON.load('{{ gitlab_default_can_create_group | to_json}}')
gitlab_rails['gitlab_username_changing_enabled'] = JSON.load('{{ gitlab_username_changing_enabled | to_json}}')

### Default Theme
gitlab_rails['gitlab_default_theme'] = JSON.load('{{ gitlab_default_theme | to_json}}')

### Default project feature settings
gitlab_rails['gitlab_default_projects_features_issues']             = JSON.load('{{ gitlab_default_projects_features_issues| to_json}}')
gitlab_rails['gitlab_default_projects_features_merge_requests']     = JSON.load('{{ gitlab_default_projects_features_merge_requests| to_json}}')
gitlab_rails['gitlab_default_projects_features_wiki']               = JSON.load('{{ gitlab_default_projects_features_wiki | to_json}}')
gitlab_rails['gitlab_default_projects_features_snippets']           = JSON.load('{{ gitlab_default_projects_features_snippets| to_json}}')
gitlab_rails['gitlab_default_projects_features_builds']             = JSON.load('{{ gitlab_default_projects_features_builds| to_json}}')
gitlab_rails['gitlab_default_projects_features_container_registry'] = JSON.load('{{ gitlab_default_projects_features_container_registry| to_json}}')
...
gitlab_rails['gitlab_stuck_ci_jobs_worker_cron'] = JSON.load('{{ gitlab_stuck_ci_jobs_worker_cron| to_json}}')
gitlab_rails['gitlab_expire_build_artifacts_worker_cron'] = JSON.load('{{ gitlab_expire_build_artifacts_worker_cron | to_json}}')
gitlab_rails['gitlab_pipeline_schedule_worker_cron'] = JSON.load('{{ gitlab_pipeline_schedule_worker_cron | to_json}}')
gitlab_rails['gitlab_repository_check_worker_cron'] = JSON.load('{{ gitlab_repository_check_worker_cron | to_json}}')
...
###! request (default: 10)
gitlab_rails['webhook_timeout'] = JSON.load('{{ gitlab_webhook_timeout | to_json}}')
...
gitlab_rails['trusted_proxies'] = JSON.load('{{ gitlab_trusted_proxies|to_json}}')
...
gitlab_rails['gitlab_signup_enabled'] = JSON.load('{{ gitlab_signup_enabled | to_json}}')
...
gitlab_rails['gitlab_signin_enabled'] = JSON.load('{{ gitlab_signin_enabled | to_json}}')
...
gitlab_rails['incoming_email_enabled'] = JSON.load('{{ gitlab_incoming_email_enabled | to_json}}')
...
gitlab_rails['incoming_email_address'] = JSON.load('{{ gitlab_incoming_email_address | to_json}}')

#### Email account username
####! **With third party providers, this is usually the full email address.**
####! **With self-hosted email servers, this is usually the user part of the
####!   email address.**
gitlab_rails['incoming_email_email'] = JSON.load('{{ gitlab_incoming_email_user | to_json}}')

#### Email account password
gitlab_rails['incoming_email_password'] = JSON.load('{{ gitlab_incoming_email_password | to_json}}')

#### IMAP Settings
gitlab_rails['incoming_email_host'] = JSON.load('{{ gitlab_incoming_email_host | to_json}}')
gitlab_rails['incoming_email_port'] = JSON.load('{{ gitlab_incoming_email_port | to_json}}')
gitlab_rails['incoming_email_ssl'] = JSON.load('{{ gitlab_incoming_email_ssl | to_json}}')
gitlab_rails['incoming_email_start_tls'] = JSON.load('{{ gitlab_incoming_email_start_tls| to_json}}')

#### Incoming Mailbox Settings
####! The mailbox where incoming mail will end up. Usually "inbox".
gitlab_rails['incoming_email_mailbox_name'] = JSON.load('{{ gitlab_incoming_email_mailbox | to_json}}')
####! The IDLE command timeout.
gitlab_rails['incoming_email_idle_timeout'] = JSON.load('{{ gitlab_incoming_email_idle_timeout | to_json}}')

### Job Artifacts
gitlab_rails['artifacts_enabled'] = JSON.load('{{ gitlab_artifacts_enabled|to_json}}')
...
### Git LFS
gitlab_rails['lfs_enabled'] = JSON.load('{{ gitlab_lfs_enabled|to_json}}')
...
gitlab_rails['ldap_enabled'] = JSON.load('{{ gitlab_ldap_enabled | to_json}}')
gitlab_rails['ldap_servers'] = JSON.load('{{ gitlab_ldap_servers | to_json}}')
...
gitlab_rails['manage_backup_path'] = JSON.load('{{ gitlab_manage_backup_path | to_json}}')

gitlab_rails['backup_path'] = JSON.load('{{ gitlab_backup_path | to_json}}')
...
gitlab_rails['backup_keep_time'] = JSON.load('{{ gitlab_backup_keep_time | to_json}}')
...
### Gitaly settings
gitlab_rails['gitaly_token'] = JSON.load('{{ gitlab_gitaly_token | to_json}}')
...
gitlab_rails['git_max_size'] = JSON.load('{{ gitlab_git_max_size|to_json}}')
gitlab_rails['git_timeout'] = JSON.load('{{ gitlab_git_timeout|to_json}}')
gitlab_rails['gitlab_shell_git_timeout'] = JSON.load('{{ gitlab_gitlab_shell_git_timeout |to_json}}')
...
gitlab_rails['auto_migrate'] = JSON.load('{{ gitlab_auto_migrate|to_json}}')
...
gitlab_workhorse['enable'] = JSON.load('{{ gitlab_workhorse_enabled|to_json}}')
...
nginx['enable'] = JSON.load('{{ gitlab_nginx_enable | to_json}}')
nginx['client_max_body_size'] = JSON.load('{{ gitlab_nginx_client_max_body_size | to_json}}')
nginx['redirect_http_to_https'] = JSON.load('{{ gitlab_nginx_redirect_http_to_https | to_json}}')
nginx['redirect_http_to_https_port'] = JSON.load('{{ gitlab_nginx_redirect_http_to_https_port | to_json}}')
...
nginx['listen_https'] = JSON.load('{{ gitlab_nginx_listen_https|to_json}}')

# nginx['custom_gitlab_server_config'] = "location ^~ /foo-namespace/bar-project/raw/ {\n deny all;\n}\n"
# nginx['custom_nginx_config'] = "include /etc/nginx/conf.d/example.conf;"
# nginx['proxy_read_timeout'] = 3600
# nginx['proxy_connect_timeout'] = 300
nginx['proxy_set_headers'] = JSON.load('{{ gitlab_nginx_proxy_set_headers|to_json}}')
...
nginx['cache_max_size'] = JSON.load('{{ gitlab_nginx_cache_max_size | to_json }}')
...
################################################################################
logrotate['enable'] = JSON.load('{{gitlab_logrotate_enabled|to_json}}')
...
gitlab_pages['enable'] = JSON.load('{{ gitlab_pages_enable|to_json}}')
...
prometheus['enable'] = JSON.load('{{ gitlab_prometheus_enable | to_json}}')
prometheus['listen_addr'] = JSON.load('{{ gitlab_prometheus_listen_addr | to_json}}')
...
##! Docs:
################################################################################
gitaly['enable'] = JSON.load('{{ gitlab_gitaly_enable | to_json}}')
gitaly['dir'] = JSON.load('{{ gitlab_gitaly_dir | to_json}}')
gitaly['log_directory'] = JSON.load('{{ gitlab_gitaly_log_directory | to_json}}')
gitaly['bin_path'] = JSON.load('{{ gitlab_gitaly_bin_path | to_json}}')
gitaly['env_directory'] = JSON.load('{{ gitlab_gitaly_env_directory | to_json}}')
gitaly['env'] = JSON.load('{{ gitlab_gitaly_env | to_json}}')
gitaly['socket_path'] = JSON.load('{{ gitlab_gitaly_socket_path | to_json}}')
gitaly['listen_addr'] = JSON.load('{{ gitlab_gitaly_listen_addr | to_json}}')
# gitaly['prometheus_listen_addr'] =JSON.load('{{ gitlab_gitaly_prometheus_listen_addr | to_json}}')
